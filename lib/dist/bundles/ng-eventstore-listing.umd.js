(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('rxjs/operators'), require('immutable'), require('lodash-es/clone'), require('rxjs'), require('@angular/common'), require('socket.io-client')) :
	typeof define === 'function' && define.amd ? define('ng-eventstore-listing', ['exports', '@angular/core', '@angular/common/http', 'rxjs/operators', 'immutable', 'lodash-es/clone', 'rxjs', '@angular/common', 'socket.io-client'], factory) :
	(factory((global['ng-eventstore-listing'] = {}),global.ng.core,global.ng.common.http,global.Rx.Observable.prototype,global.immutable,global._clone,global.rxjs,global.ng.common,global.io));
}(this, (function (exports,core,http,operators,immutable,_clone,rxjs,common,io) { 'use strict';
            ...
            try {
                ...
                if (sub) {
                    if (sub.token && _this.ioPush.connected) {
                        _this.ioPush.emit('unsubscribe', sub.token, function (ack) {
                            if (ack.error) {
...
var PlaybackListService = (function () {
...
var NgEventstoreListingComponent = (function () {
    function NgEventstoreListingComponent(changeDetectorRef, scriptService, playbackService, playbackListService) {
        ...
        this.getPlaybackListSubject = new rxjs.Subject();
...
var ItemTemplateHolderComponent = (function () {
...
var NgHeaderFooterTemplateHolderComponent = (function () {
    function NgHeaderFooterTemplateHolderComponent(componentFactoryResolver) {
        this.componentFactoryResolver = componentFactoryResolver;
        this.headerData = {};
        this.maxSize = 5;
        this.actionEmitter = new core.EventEmitter();
        this.pageChangedEmitter = new core.EventEmitter();
        this.filterEmitter = new core.EventEmitter();
    }
    NgHeaderFooterTemplateHolderComponent.prototype.ngOnInit = function () {
    };
    NgHeaderFooterTemplateHolderComponent.prototype.ngAfterViewInit = function () {
        this.loadComponent();
    };
    NgHeaderFooterTemplateHolderComponent.prototype.ngOnChanges = function (changes) {
        var self = this;
        if (self.componentRef) {
            var changesKeys = Object.keys(changes);
            changesKeys.forEach(function (key) {
    ...
    NgHeaderFooterTemplateHolderComponent.prototype.loadComponent = function () {
...
NgHeaderFooterTemplateHolderComponent.ctorParameters = function () { return [
    { type: core.ComponentFactoryResolver, },
]; };
NgHeaderFooterTemplateHolderComponent.propDecorators = {
    "componentClass": [{ type: core.Input },],
    "headerData": [{ type: core.Input },],
    "pageIndex": [{ type: core.Input },],
    "itemsPerPage": [{ type: core.Input },],
    "actualItemCount": [{ type: core.Input },],
    "totalItemCount": [{ type: core.Input },],
    "maxSize": [{ type: core.Input },],
    "actionEmitter": [{ type: core.Output },],
    "pageChangedEmitter": [{ type: core.Output },],
    "filterEmitter": [{ type: core.Output },],
    "itemHost": [{ type: core.ViewChild, args: [TemplateDirective,] },],
};
var ɵ0 = io;
var NgEventstoreListingModule = (function () {
...
exports.ɵi = NgHeaderFooterTemplateHolderComponent;
