(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('rxjs/operators'), require('rxjs/Subject'), require('immutable'), require('lodash-es/clone'), require('moment-mini-ts'), require('file-saver'), require('@angular/common'), require('socket.io-client')) :
	typeof define === 'function' && define.amd ? define('ng-eventstore-listing', ['exports', '@angular/core', '@angular/common/http', 'rxjs/operators', 'rxjs/Subject', 'immutable', 'lodash-es/clone', 'moment-mini-ts', 'file-saver', '@angular/common', 'socket.io-client'], factory) :
	(factory((global['ng-eventstore-listing'] = {}),global.ng.core,global.ng.common.http,global.Rx.Observable.prototype,global.Rx,global.immutable,global._clone,global.moment_,global.saveAs,global.ng.common,global.io));
}(this, (function (exports,core,http,operators,Subject,immutable,_clone,moment_,saveAs,common,io) { 'use strict';
...
var NgEventstoreListingComponent = /** @class */ (function () {
    function NgEventstoreListingComponent(changeDetectorRef, scriptService, playbackService, playbackListService) {
        ...
        this.csvFileName = this.playbackListName;
        ...
        this._playbackList = {
            ...
            delete: function (rowId, callback) {
                ...
                if (rowIndex > -1) {
                    _this._dataList = _this._dataList.remove(rowIndex);
                    callback(null);
                }
                else {
                    callback(new Error("Row with rowId: " + rowIndex + " does not exist"));
    ...
    NgEventstoreListingComponent.prototype._initializeRequests = function () {
        ...
        this._exportPlaybackListSubscription = this._exportPlaybackListSubject
            ...
            var csv = new Blob([result.data], { type: 'text/csv' });
            var moment = moment_;
            var now = moment();
            var fileName = now.format('YYYY_MM_DD_HH_mm_ss') + "_" + _this.csvFileName + ".csv";
            saveAs(csv, fileName);
        });
    };
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, self.playbackService.registerForPlayback(self.itemSubscriptionConfiguration.playbackScriptName, self, query, self.stateFunctions, row.get('revision') + 1, self._playbackList)];
                                    case 1:
                                        _b.apply(_a, [_c.sent()]);
                                        return [2 /*return*/];
                                }
                        ...
                        _b = (_a = this._subscriptionTokens).push;
                        return [4 /*yield*/, self.playbackService.registerForPlayback(self.listSubscriptionConfiguration.playbackScriptName, self, self.listSubscriptionConfiguration.query, self.stateFunctions, 0, self._playbackList)];
                    case 1:
                        _b.apply(_a, [_c.sent()]);
                        return [2 /*return*/];
                }
