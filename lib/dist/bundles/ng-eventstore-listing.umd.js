                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.pushService.subscribe(query, offset, this, function (err, eventObj, owner2, token) {
                                ...
                                if (eventObj.context === 'states') {
                                    var scriptName_1 = registration.scriptName;
                                    var fromEvent = eventObj.payload._meta.fromEvent;
                                    var eventName = fromEvent.payload.name;
                                    var playbackScript_1 = window[scriptName_1];
                                    var playbackFunction = playbackScript_1.playbackInterface[eventName];
                                    if (playbackFunction) {
                                    ...
                                    var scriptName_2 = registration.scriptName;
                                    var playbackScript_2 = window[scriptName_2];
                                    var playbackFunction = playbackScript_2.playbackInterface[eventObj.payload.name];
                                    if (playbackFunction) {
                                        var row = stateFunctions.getState(eventObj.aggregateId);
                                        var state = row.data;
                                        var funcs = {
...
exports.ɵf = ItemTemplateHolderComponent;
exports.ɵg = TemplateDirective;
exports.ɵe = PlaybackListService;
