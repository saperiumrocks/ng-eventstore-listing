(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('lodash-es/forOwn'), require('lodash-es/clone'), require('socket.io-client'), require('@angular/common/http'), require('rxjs/operators'), require('rxjs/Subject'), require('immutable'), require('moment-mini-ts'), require('file-saver'), require('@angular/common'), require('@angular/forms')) :
	typeof define === 'function' && define.amd ? define('ng-eventstore-listing', ['exports', '@angular/core', 'lodash-es/forOwn', 'lodash-es/clone', 'socket.io-client', '@angular/common/http', 'rxjs/operators', 'rxjs/Subject', 'immutable', 'moment-mini-ts', 'file-saver', '@angular/common', '@angular/forms'], factory) :
	(factory((global['ng-eventstore-listing'] = {}),global.ng.core,global._forOwn,global._clone,global.socket_ioClient,global.ng.common.http,global.Rx.Observable.prototype,global.Rx,global.immutable,global.moment_,global.saveAs,global.ng.common,global.ng.forms));
}(this, (function (exports,core,_forOwn,_clone,socket_ioClient,http,operators,Subject,immutable,moment_,saveAs,common,forms) { 'use strict';
...
var PushService = /** @class */ (function () {
    ...
    PushService.prototype.init = function (socketUrl) {
        ...
        var self = this;
        this.ioPush.on('message', function (eventObj, queryKey) {
    ...
    PushService.prototype.subscribe = function (query, offset, owner, cb) {
        var clientToken = Math.random().toString(36).substr(2, 9) + '-' + Date.now().toString();
    ...
    PushService.prototype.unsubscribe = function (clientTokens) {
        var _this = this;
        var socketTokens = [];
        clientTokens.forEach(function (clientToken) {
            if (_this.subscriptions[clientToken]) {
                var clientSubscription = _clone(_this.subscriptions[clientToken]);
...
var PlaybackService = /** @class */ (function () {
    function PlaybackService(scriptService, pushService) {
        ...
        this.conditionalSubscriptionRegistry = {};
    }
    PlaybackService.prototype.init = function (socketUrl) {
        this.pushService.init(socketUrl);
    };
    PlaybackService.prototype.unRegisterForPlayback = function (tokens) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.pushService.unsubscribe(tokens)];
                    case 1:
                        _a.sent();
                        tokens.forEach(function (token) {
                            delete _this.playbackRegistry[token];
                        });
                        return [2 /*return*/];
                }
            });
    ...
    PlaybackService.prototype.registerForPlayback = function (owner, scriptName, query, stateFunctions, playbackList, streamRevisionFunction, rowId, conditionFunction) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var playbackSubscriptionId, script, playbackScript, rowData, aggregateId_1, streamRevision, isConditionTrue, pushSubscriptionId;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        playbackSubscriptionId = Math.random().toString(36).substr(2, 9) + '-' + Date.now().toString();
                        return [4 /*yield*/, this.scriptService.getScript(scriptName)];
                    case 1:
                        script = _a.sent();
                        if (script) {
                            playbackScript = window[script.meta.objectName];
                        }
                        if (!rowId) return [3 /*break*/, 3];
                    ...
                    case 3:
                        ...
                        if (!(isConditionTrue === true || conditionFunction === undefined)) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.pushService.subscribe(query, streamRevision, this, function (err, eventObj, owner2) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    ...
                                    registration = self.playbackRegistry[playbackSubscriptionId];
    ...
    PlaybackService.prototype.registerConditionalSubscriptions = function (conditionFunction, scriptName, owner, query, stateFunctions, playbackList, rowId, streamRevisionFunction, subscriptionToken) {
        return __awaiter(this, void 0, void 0, function () {
        ...
        conditionalSubscriptions.forEach(function (conditionalSubscription) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (!conditionalSubscription.subscriptionToken && conditionalSubscription.conditionFunction(rowData)) {
                    ...
                    subscriptionId = this.pushService.subscribe(conditionalSubscription.query, offset, this, function (err, eventObj, owner2, token) { return __awaiter(_this, void 0, void 0, function () {
                        var self, registration, thisScriptName, fromEvent, eventName, thisPlaybackScript, playbackFunction, state, funcs, doneCallback, thisScriptName, thisPlaybackScript, playbackFunction, row, state, funcs, doneCallback;
                        return __generator(this, function (_a) {
                            self = (owner2);
                            registration = self.playbackRegistry[token];
                            if (eventObj.aggregate === 'states') {
                                thisScriptName = registration.scriptName;
                                fromEvent = eventObj.payload._meta.fromEvent;
                                eventName = fromEvent.payload.name;
                    ...
                    this.pushService.unsubscribe([conditionalSubscription.subscriptionToken]).then(function () {
                        delete _this.playbackRegistry[conditionalSubscription.subscriptionToken];
...
var NgEventstoreListingComponent = /** @class */ (function () {
    function NgEventstoreListingComponent(changeDetectorRef, scriptService, playbackService, playbackListService) {
        ...
        this._getPlaybackListSubject = new Subject.Subject();
        this._exportPlaybackListSubject = new Subject.Subject();
    ...
    NgEventstoreListingComponent.prototype._initializeRequests = function () {
        ...
        this._getPlaybackListSubscription = this._getPlaybackListSubject
            ...
            _this._dataList = immutable.fromJS(res.rows);
...
exports.ɵe = ItemTemplateHolderComponent;
exports.ɵf = TemplateDirective;
exports.ɵd = PlaybackListService;
exports.ɵb = PlaybackService;
exports.ɵc = PushService;
exports.ɵa = ScriptService;
exports.ɵg = SocketIoService;
