(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/operators'), require('rxjs'), require('lodash-es/clone'), require('lodash-es/forOwn'), require('socket.io-client'), require('@angular/common/http'), require('immutable'), require('lodash-es/isEmpty'), require('moment-mini-ts'), require('file-saver'), require('@angular/common'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('ng-eventstore-listing', ['exports', '@angular/core', 'rxjs/operators', 'rxjs', 'lodash-es/clone', 'lodash-es/forOwn', 'socket.io-client', '@angular/common/http', 'immutable', 'lodash-es/isEmpty', 'moment-mini-ts', 'file-saver', '@angular/common', '@angular/forms'], factory) :
    (global = global || self, factory(global['ng-eventstore-listing'] = {}, global.ng.core, global.rxjs.operators, global.rxjs, global._clone, global._forOwn, global.socket_ioClient, global.ng.common.http, global.immutable, global._isEmpty, global.moment_, global.saveAs, global.ng.common, global.ng.forms));
}(this, (function (exports, core, operators, rxjs, _clone, _forOwn, socket_ioClient, http, immutable, _isEmpty, moment_, saveAs, common, forms) { 'use strict';

    _clone = _clone && Object.prototype.hasOwnProperty.call(_clone, 'default') ? _clone['default'] : _clone;
    _forOwn = _forOwn && Object.prototype.hasOwnProperty.call(_forOwn, 'default') ? _forOwn['default'] : _forOwn;
    _isEmpty = _isEmpty && Object.prototype.hasOwnProperty.call(_isEmpty, 'default') ? _isEmpty['default'] : _isEmpty;
    ...
    ***************************************************************************** */
    ...
    var NgEventstoreListingComponent = /** @class */ (function () {
        ...
        NgEventstoreListingComponent = __decorate([
            ...
            __param(0, core.Inject(JQ_TOKEN))
    ...
    var ItemTemplateHolderComponent = /** @class */ (function () {
        ...
        __decorate([
            core.ViewChild(TemplateDirective, { static: false })
    ...
    })(exports.GroupBooleanOperator || (exports.GroupBooleanOperator = {}));
