(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('lodash-es/forOwn'), require('lodash-es/clone'), require('socket.io-client'), require('@angular/common/http'), require('rxjs/operators'), require('rxjs/Subject'), require('rxjs/operators/map'), require('immutable'), require('lodash-es/isEmpty'), require('moment-mini-ts'), require('file-saver'), require('@angular/common'), require('@angular/forms')) :
	typeof define === 'function' && define.amd ? define('ng-eventstore-listing', ['exports', '@angular/core', 'lodash-es/forOwn', 'lodash-es/clone', 'socket.io-client', '@angular/common/http', 'rxjs/operators', 'rxjs/Subject', 'rxjs/operators/map', 'immutable', 'lodash-es/isEmpty', 'moment-mini-ts', 'file-saver', '@angular/common', '@angular/forms'], factory) :
	(factory((global['ng-eventstore-listing'] = {}),global.ng.core,global._forOwn,global._clone,global.socket_ioClient,global.ng.common.http,global.Rx.Observable.prototype,global.Rx,global.Rx.Observable.prototype,global.immutable,global._isEmpty,global.moment_,global.saveAs,global.ng.common,global.ng.forms));
}(this, (function (exports,core,_forOwn,_clone,socket_ioClient,http,operators,Subject,map,immutable,_isEmpty,moment_,saveAs,common,forms) { 'use strict';
...
var NgEventstoreListingComponent = /** @class */ (function () {
    ...
    NgEventstoreListingComponent.prototype._initializeRequests = function () {
        ...
        self._exportPlaybackListSubscription = self._exportPlaybackListSubject
            ...
            return self.playbackListService.getPlaybackListCsv(self.playbackListBaseUrl, playbackListRequest.playbackListName, playbackListRequest.startIndex, playbackListRequest.limit, playbackListRequest.filters, playbackListRequest.sort, playbackListRequest.type).pipe(map.map(function (response) {
