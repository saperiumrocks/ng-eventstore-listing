(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('lodash-es/forOwn'), require('socket.io-client'), require('@angular/common/http'), require('rxjs/operators'), require('rxjs/Subject'), require('immutable'), require('lodash-es/clone'), require('moment-mini-ts'), require('file-saver'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define('ng-eventstore-listing', ['exports', '@angular/core', 'lodash-es/forOwn', 'socket.io-client', '@angular/common/http', 'rxjs/operators', 'rxjs/Subject', 'immutable', 'lodash-es/clone', 'moment-mini-ts', 'file-saver', '@angular/common'], factory) :
	(factory((global['ng-eventstore-listing'] = {}),global.ng.core,global._forOwn,global.socket_ioClient,global.ng.common.http,global.Rx.Observable.prototype,global.Rx,global.immutable,global._clone,global.moment_,global.saveAs,global.ng.common));
}(this, (function (exports,core,_forOwn,socket_ioClient,http,operators,Subject,immutable,_clone,moment_,saveAs,common) { 'use strict';
