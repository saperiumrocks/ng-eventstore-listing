...
class PushService {
     ...
     * @return {?}
     */
    unsubscribe(clientTokens) {
        const /** @type {?} */ socketTokens = [];
        clientTokens.forEach((clientToken) => {
            if (this.subscriptions[clientToken]) {
                const /** @type {?} */ clientSubscription = _clone(this.subscriptions[clientToken]);
...
class PlaybackService {
     ...
     * @return {?}
     */
    unRegisterForPlayback(tokens) {
        return __awaiter(this, void 0, void 0, function* () {
            // unsubscribe from push
            yield this.pushService.unsubscribe(tokens);
     ...
     * @return {?}
     */
    registerForPlayback(owner, scriptName, query, stateFunctions, playbackList, streamRevisionFunction = (item) => { return 0; }, rowId, conditionFunction) {
        return __awaiter(this, void 0, void 0, function* () {
            const /** @type {?} */ playbackSubscriptionId = Math.random().toString(36).substr(2, 9) + '-' + Date.now().toString();
            const /** @type {?} */ script = yield this.scriptService.getScript(scriptName);
            let /** @type {?} */ playbackScript;
            if (script) {
            ...
            const /** @type {?} */ streamRevision = streamRevisionFunction(rowData);
            // Check if condition is true
            const /** @type {?} */ isConditionTrue = conditionFunction ? conditionFunction(rowData) : undefined;
            ...
            if (isConditionTrue === true || conditionFunction === undefined) {
                pushSubscriptionId = yield this.pushService.subscribe(query, streamRevision, this, (err, eventObj, owner2) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const /** @type {?} */ registration = self.playbackRegistry[playbackSubscriptionId];
     ...
     * @return {?}
     */
    registerConditionalSubscriptions(conditionFunction, scriptName, owner, query, stateFunctions, playbackList, rowId, streamRevisionFunction, subscriptionToken) {
        return __awaiter(this, void 0, void 0, function* () {
            const /** @type {?} */ script = yield this.scriptService.getScript(scriptName);
            let /** @type {?} */ playbackScript;
            if (script) {
    ...
    _updateConditionalSubscriptions(rowId, rowData) {
        const /** @type {?} */ conditionalSubscriptions = this.conditionalSubscriptionRegistry[rowId] || [];
        conditionalSubscriptions.forEach((conditionalSubscription) => __awaiter(this, void 0, void 0, function* () {
            if (!conditionalSubscription.subscriptionToken && conditionalSubscription.conditionFunction(rowData)) {
                ...
                const /** @type {?} */ subscriptionId = this.pushService.subscribe(conditionalSubscription.query, offset, this, (err, eventObj, owner2, token) => __awaiter(this, void 0, void 0, function* () {
                    // owner is playbackservice
                    const /** @type {?} */ self = /** @type {?} */ (owner2);
    ...
    _initSubscriptions() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (self.itemSubscriptionConfigurations || []).forEach((itemSubscriptionConfiguration) => {
                if (itemSubscriptionConfiguration) {
                    self._dataList.forEach((row) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        const /** @type {?} */ aggregateId = itemSubscriptionConfiguration.rowIdFieldName ?
                        ...
                        const /** @type {?} */ playbackSubscriptionToken = yield self.playbackService.registerForPlayback(self, itemSubscriptionConfiguration.playbackScriptName, query, self._stateFunctions, self._playbackList, streamRevisionFunction, row.get('rowId'), itemSubscriptionConfiguration.condition);
            ...
            if (self.listSubscriptionConfiguration) {
                // List subscription
                this._playbackSubscriptionTokens.push(yield self.playbackService.registerForPlayback(self, self.listSubscriptionConfiguration.playbackScriptName, self.listSubscriptionConfiguration.query, self._stateFunctions, self._playbackList, () => { return 0; }));
            }
        });
    }
    /**
