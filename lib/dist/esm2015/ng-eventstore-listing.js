import { Injectable, InjectionToken, Inject, Component, Input, Output, EventEmitter, ChangeDetectionStrategy, ChangeDetectorRef, Directive, ViewContainerRef, ViewChild, ComponentFactoryResolver, NgModule } from '@angular/core';
...
class PushService {
    ...
    subscribeStreams() {
        if (this.ioPush.connected) {
            const /** @type {?} */ clientTokens = Object.keys(this.subscriptions);
            clientTokens.forEach((clientToken) => {
                ...
                if (!sub.token) {
                    ...
                    const /** @type {?} */ query = Object.assign(sub.query, {
                        offset: sub.offset,
                    });
...
class PlaybackService {
    ...
    registerForPlayback(scriptName, owner, query, stateFunctions, offset, playbackList) {
        return __awaiter(this, void 0, void 0, function* () {
            const /** @type {?} */ script = yield this.scriptService.load(scriptName);
            const /** @type {?} */ playbackScript = window[script[0].meta.objectName];
...
class NgHeaderFooterTemplateHolderComponent {
    ...
    ngOnChanges(changes) {
        ...
        if (self.componentRef) {
            const /** @type {?} */ changesKeys = Object.keys(changes);
            changesKeys.forEach((key) => {
                (/** @type {?} */ (self.componentRef.instance))[key] = changes[key].currentValue;
            });
            (/** @type {?} */ (self.componentRef.instance)).updatePageValues();
        }
    }
    /**
     * @return {?}
     */
    loadComponent() {
        const /** @type {?} */ componentFactory = this.componentFactoryResolver.resolveComponentFactory(this.componentClass);
        const /** @type {?} */ viewContainerRef = this.itemHost.viewContainerRef;
        viewContainerRef.clear();
        this.componentRef = viewContainerRef.createComponent(componentFactory);
        (/** @type {?} */ (this.componentRef.instance)).data = this.headerData;
        (/** @type {?} */ (this.componentRef.instance)).pageIndex = this.pageIndex;
        (/** @type {?} */ (this.componentRef.instance)).itemsPerPage = this.itemsPerPage;
        (/** @type {?} */ (this.componentRef.instance)).totalItemCount = this.totalItemCount;
        (/** @type {?} */ (this.componentRef.instance)).actualItemCount = this.actualItemCount;
        (/** @type {?} */ (this.componentRef.instance)).maxSize = this.maxSize;
        (/** @type {?} */ (this.componentRef.instance)).actionEmitter = this.actionEmitter;
        (/** @type {?} */ (this.componentRef.instance)).pageChangedEmitter = this.pageChangedEmitter;
        (/** @type {?} */ (this.componentRef.instance)).filterEmitter = this.filterEmitter;
        (/** @type {?} */ (this.componentRef.instance)).ngOnInit();
        (/** @type {?} */ (this.componentRef.instance)).updatePageValues();
    }
}
NgHeaderFooterTemplateHolderComponent.decorators = [
    { type: Component, args: [{
...
/** @nocollapse */
NgHeaderFooterTemplateHolderComponent.ctorParameters = () => [
    { type: ComponentFactoryResolver, },
];
NgHeaderFooterTemplateHolderComponent.propDecorators = {
    "componentClass": [{ type: Input },],
    "headerData": [{ type: Input },],
    "pageIndex": [{ type: Input },],
    "itemsPerPage": [{ type: Input },],
    "actualItemCount": [{ type: Input },],
    "totalItemCount": [{ type: Input },],
    "maxSize": [{ type: Input },],
    "actionEmitter": [{ type: Output },],
    "pageChangedEmitter": [{ type: Output },],
    "filterEmitter": [{ type: Output },],
    "itemHost": [{ type: ViewChild, args: [TemplateDirective,] },],
};
...
export { FilterOperator, SortDirection, ItemTemplateComponent, NgEventstoreListingModule, ItemTemplateHolderComponent as ɵg, NgHeaderFooterTemplateHolderComponent as ɵi, TemplateDirective as ɵh, NgEventstoreListingComponent as ɵa, PlaybackListService as ɵf, PlaybackService as ɵc, PushService as ɵd, ScriptService as ɵb, IO_TOKEN as ɵe };
