    ...
    _updateConditionalSubscriptions(rowId, rowData) {
        ...
        conditionalSubscriptions.forEach((conditionalSubscription) => __awaiter(this, void 0, void 0, function* () {
            if (!conditionalSubscription.pushSubscriptionId && conditionalSubscription.conditionFunction(rowData)) {
                ...
                const /** @type {?} */ subQuery = _clone(conditionalSubscription.query);
                if (conditionalSubscription.rowIdFunction) {
                    subQuery.aggregateId = conditionalSubscription.rowIdFunction(rowData);
                }
                const /** @type {?} */ pushSubscriptionId = this.pushService.subscribe(subQuery, offset, this, (err, eventObj, owner2) => __awaiter(this, void 0, void 0, function* () {
                    // owner is playbackservice
                    const /** @type {?} */ self = /** @type {?} */ (owner2);
...
class NgEventstoreListingComponent {
    ...
    _fixLoadingOverlayPosition() {
        const /** @type {?} */ $ = this.$;
        const /** @type {?} */ windowY = window.pageYOffset;
        const /** @type {?} */ pageHeaderSectionHeight = 53;
        const /** @type {?} */ pageHeaderSectionBottomY = $(this.loadingTopBoundSelector).offset().top + pageHeaderSectionHeight;
        ...
        if (windowY < pageHeaderSectionBottomY) {
            ...
            const /** @type {?} */ pageHeaderHeight = pageHeaderSectionHeight;
