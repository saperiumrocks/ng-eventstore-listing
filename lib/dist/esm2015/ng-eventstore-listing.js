        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const /** @type {?} */ subscriptionId = yield this.pushService.subscribe(query, offset, this, (err, eventObj, owner2, token) => {
                ...
                if (eventObj.context === 'states') {
                    const /** @type {?} */ scriptName = registration.scriptName;
                    const /** @type {?} */ fromEvent = eventObj.payload._meta.fromEvent;
                    const /** @type {?} */ eventName = fromEvent.payload.name;
                    const /** @type {?} */ playbackScript = window[scriptName];
                    const /** @type {?} */ playbackFunction = playbackScript.playbackInterface[eventName];
                    if (playbackFunction) {
                    ...
                    //   ];
                    const /** @type {?} */ playbackScript = window[scriptName];
                    const /** @type {?} */ playbackFunction = playbackScript.playbackInterface[eventObj.payload.name];
                    if (playbackFunction) {
                        const /** @type {?} */ row = stateFunctions.getState(eventObj.aggregateId);
                        const /** @type {?} */ state = row.data;
                        const /** @type {?} */ funcs = {
