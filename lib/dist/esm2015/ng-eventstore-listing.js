...
class NgEventstoreListingComponent {
    ...
    _initializeRequests() {
        ...
        self._exportPlaybackListSubscription = self._exportPlaybackListSubject
            .pipe(debounceTime(100), switchMap((params) => {
            const /** @type {?} */ playbackListRequest = params.playbackListRequest;
            ...
            const /** @type {?} */ fileName = `${fileNameOverride || this.csvFileName || this.playbackListName}-${now.format('YYYY-MM-DD_HHmmss')}.csv`;
            saveAs(csv, fileName);
        });
    }
    /**
