...
describe('HeaderTemplateHolderComponent', () => {
  ...
  beforeEach(() => {
    mockComponentFactoryResolver = jasmine.createSpyObj(
    ...
    component = new NgHeaderFooterTemplateHolderComponent(
  ...
  describe('ngOnChanges', () => {
    it('should apply updated values to the component instance', () => {
      component.componentRef = {
        instance: { initPageValues: () => {}, updatePageValues: () => {} },
      } as any;
