...
export class ItemTemplateHolderComponent implements OnInit, OnChanges, AfterViewInit {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if (self.componentRef) {
      ...
      changesKeys.forEach((key) => {
        (self.componentRef.instance as ItemTemplateComponent)[key] = changes[key].currentValue;
      });
      (self.componentRef.instance as ItemTemplateComponent).ngOnChanges(changes);
    } else {
  ...
  loadComponent(): void {
    ...
    (this.componentRef.instance as ItemTemplateComponent).onUpdateEmitter = this.updateEmitter;
    (this.componentRef.instance as ItemTemplateComponent).onUpdateLookupsEmitter = this.updateLookupsEmitter;
    (this.componentRef.instance as ItemTemplateComponent).onShowModalEmitter = this.showModalEmitter;
    (this.componentRef.instance as ItemTemplateComponent).onDeleteEmitter = this.deleteEmitter;
    (this.componentRef.instance as ItemTemplateComponent).idPropertyName = this.idPropertyName;
    (this.componentRef.instance as ItemTemplateComponent).lookups = this.lookups;
